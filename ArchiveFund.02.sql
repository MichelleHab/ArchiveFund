...
INSERT INTO `DeletedDocuments` VALUES (1,'Старая версия диплома',1,'Скрыльников Дмитрий Константинович',1),(2,'курсовая 1',1,'Нуралиева Ирина Евгеньевна',2),(3,'Предварительный отчет',2,'Федусева Элла Юрьевна',3),(4,'Неактуальный реферат',2,'Нуралиев Арсен Абдулжалилович',4),(5,'Дубликат диплома',2,'Стрельцова Анна Федоровна',5),(6,'Устаревшая статья н11',3,'Ермольчев Константин Васильевич',6),(7,'Отклоненный патент',2,'Кирюхина Оксана Юрьевна',7),(8,'свидетельство о рождения',1,'Дудник Наталья Борисовна',8),(9,'Просроченный сертификат',1,'Попова Вероника Владимировна',9);
...
INSERT INTO `User` VALUES (1,'Иванов Иван Иванович','Admin','ivanov_ii','pass1234'),(2,'Петрова Мария Сергеевна','Employer','petrova_ms','qwerty567'),(3,'Сидоров Алексей Владимирович','Employer','sidorov_av','securepass88'),(4,'Козлова Елена Дмитриевна','Admin','kozlova_ed','mypass2024'),(5,'Николаев Дмитрий Олегович','Employer','nikolaev_do','testpass99'),(6,'Федорова Анна Викторовна','Employer','fedorova_av','hello123'),(7,'Морозов Сергей Петрович','Admin','morozov_sp','strongpass456'),(8,'Волкова Юлия Андреевна','Employer','volkova_ya','letmein789'),(9,'Павлов Андрей Николаевич','Employer','pavlov_an','mypassword00'),(10,'Лебедева Ольга Константиновна','Admin','lebedeva_ok','secret111');
...
-- Dump completed on 2026-04-08 21:15:38
